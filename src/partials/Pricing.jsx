        ...
        <section className="">
            <div className="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6">
                <div className="mx-auto max-w-screen-md text-center mb-8 lg:mb-12">
                    <h2 className="mb-4 text-4xl tracking-tight font-extrabold text-gray-900 dark:text-white">Pricing plans for your needs</h2>
                ...
                <div className="space-y-8 lg:grid lg:grid-cols-3 sm:gap-6 xl:gap-10 lg:space-y-0">
                    ...
                    <div className="flex flex-col p-6 mx-auto max-w-lg text-center text-gray-900 bg-gray-700 rounded-lg border border-gray-100 ring-4 ring-purple-600 shadow dark:border-gray-600 xl:p-8 dark:bg-purple-900 dark:text-white">
