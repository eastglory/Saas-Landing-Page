...
import HeroImage3 from '../images/hero (3).webp';
...
function HeroHome() {
  ...
  return (
    <section className='bg-purple-950'>
      <div className="max-w-6xl mx-auto px-4 sm:px-6 relative ">
        ...
        <div className="relative pt-32 md:pt-40">
          ...
          <div className="max-w-3xl mx-auto text-center pb-12 md:pb-16">
            <h1 className="h1 mb-4 bg" data-aos="fade-up">
              Earn up to 10% for referring clients to E-CommerceX!
            </h1>
            <p className="text-xl text-gray-400 mb-8" data-aos="fade-up" data-aos-delay="200">
              Become an Affiliate Partner today and earn competitive commissions for every client or investor you refer to us. We'd love to have a referral partnership with you
            </p>
            <div className="max-w-xs mx-auto sm:max-w-none sm:flex sm:justify-center">
              <div data-aos="fade-up" data-aos-delay="400">
                <a className="btn text-white bg-purple-800 hover:bg-purple-900 w-full mb-4 sm:w-auto sm:mb-0" href="#0">
                  Become An Affiliate
                </a>
              </div>
            </div>
          ...
          <div>
            <div className="relative flex justify-center items-center" data-aos="fade-up" data-aos-delay="200">
              {/* <img className="mx-auto" src={HeroImage3} width="1024" height="504" alt="Hero" /> */}
              {/* <a
      ...
      <video ref={video} className="w-full h-full" width="1920" height="1080" loop autoPlay muted>
                  <source src="/videos/products_video.mp4" type="video/mp4" />
                  Your browser does not support the video tag.
                </video>
    </section>
  );
